...
const formatFullTime = (date: Date) =>
  `${isToday(date) ? "Today" : isYesterday(date) ? "Yesterday" : format(date, "MMM d, yy")} at ${format(date, "h:mm:ss a")}`;
      ...
      <>
        ...
        <div
          className={cn(
            ...
            isEditing && "bg-purple-400 hover:bg-purple-200",
            isRemovingMessage &&
          ...
          {isEditing ? (
            ...
            <div className="flex flex-col w-full overflow-hidden">
              <div className="text-sm">
                ...
                <span>&nbsp;&nbsp;</span>
                <Hint label={formatFullTime(new Date(createdAt))}>
                  <button className="text-xs text-muted-foreground cursor-default">
