    ...
    return (
      <div className="h-full flex flex-col">
        <div className="flex justify-between items-center p-4 border-b">
          <p className="text-lg font-bold">Member Profile</p>
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex flex-col items-center justify-center p-4">
        <Avatar className="max-w-[150px] max-h-[150px] size-full rounded-md">
          <AvatarImage src={member.user.image} className="rounded-md" />
          <AvatarFallback className="rounded-md bg-purple-500 text-white text-3xl aspect-square">
            {avatarFallback}
          </AvatarFallback>
        </Avatar>
      </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex flex-col">
            ...
            <Link
              ...
              className="text-sm hover:underline text-purple-700"
            >
              {member.user.email}
            </Link>
          </div>
